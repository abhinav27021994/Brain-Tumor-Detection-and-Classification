...
ex_new_img = preprocessing(ex_img, True)
...
def get_glcm_features(dir_list, image_size):
    """
    ...
    for directory in dir_list:
        for filename in listdir(directory):
            ...
            image = preprocessing(image, plot=False)
            # resize image
...
X, y = get_glcm_features([augmented_yes, augmented_no], (IMG_WIDTH, IMG_HEIGHT))
...
def kfcm_segmentation(X, y, n=50):
    """
...
y_test_prob[y_test_prob>=0.5]=1
y_test_prob[y_test_prob<0.5]=0

print(sklearn.metrics.classification_report(y_test,y_test_prob))
